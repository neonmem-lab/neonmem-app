...
<p align="center">
  ...
  ·
  <a href="https://github.com/neonmem-lab/neonmem-app/releases/download/v0.9.4/Neonmem-0.9.4-x86_64.AppImage"><strong>⬇ Linux (AppImage)</strong></a>
  ·
...
> **Public beta (v0.9.4).** Windows **and Linux** (AppImage) — macOS is on the way.
...
**On Linux:** grab the
[AppImage](https://github.com/neonmem-lab/neonmem-app/releases/download/v0.9.4/Neonmem-0.9.4-x86_64.AppImage),
`chmod +x` it, and run — no install, no gatekeeper prompt. (Or the
[.tar.gz](https://github.com/neonmem-lab/neonmem-app/releases/download/v0.9.4/neonmem-0.9.4-linux.tar.gz).)

See [RELEASE-NOTES-0.9.4.md](RELEASE-NOTES-0.9.4.md) for what's in this build.
